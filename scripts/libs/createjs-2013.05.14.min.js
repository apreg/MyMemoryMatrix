...
(function () {
    ...
    a.removeEventListener =
        function (b, g) {
            ...
            if (d) {
                var a = d[b];
                if (a)for (var c = 0, e = a.length; c < e; c++)if (a[c] == g) {
    ...
    a.dispatchEvent = function (b, g) {
        var d = !1, a = this._listeners;
        if (b && a) {
            "string" == typeof b && (b = {type: b});
            a = a[b.type];
            if (!a)return d;
            b.target = g || this;
            for (var a = a.slice(), c = 0, e = a.length; c < e; c++)var h = a[c], d = h.handleEvent ? d || h.handleEvent(b) : d || h(b)
        }
        return!!d
    };
    a.hasEventListener =
...
(function () {
    ...
    c._tick = function () {
        var b = c._getTime();
        c._ticks++;
        var g = b - c._lastTime, d = c._paused;
        ...
        c.dispatchEvent({type: "tick", paused: d, delta: g, time: b, runTime: b - c._pausedTime});
...
(function () {
    ...
    a.append = function (b, g, d, a, c, e) {
        var h = this.a, m = this.b, k = this.c, p = this.d;
        this.a = b * h + g * k;
        this.b = b * m + g * p;
        this.c = d * h + a * k;
        this.d = d * m + a * p;
    ...
    a.appendTransform = function (b, g, d, a, f, e, h, m, k) {
        ...
        e ||
            h ? (e *= c.DEG_TO_RAD, h *= c.DEG_TO_RAD, this.append(Math.cos(h), Math.sin(h), -Math.sin(e), Math.cos(e), b, g), this.append(f * d, p * d, -p * a, f * a, 0, 0)) : this.append(f * d, p * d, -p * a, f * a, b, g);
    ...
    a.rotate = function (b) {
        var g = Math.cos(b);
        b = Math.sin(b);
        var d = this.a, a = this.c, c = this.tx;
        this.a = d * g - this.b * b;
        this.b = d * b + this.b * g;
        this.c = a * g - this.d * b;
        this.d = a * b + this.d * g;
    ...
    a.invert = function () {
        var b = this.a, g = this.b, d = this.c, a = this.d, c = this.tx, e = b * a - g * d;
        this.a = a / e;
        this.b = -g / e;
        this.c = -d /
            e;
    ...
    a.decompose = function (b) {
        ...
        var g = Math.atan2(-this.c, this.d), d = Math.atan2(this.b, this.a);
        g == d ? (b.rotation = d / c.DEG_TO_RAD, 0 > this.a && 0 <= this.d && (b.rotation += 0 >= b.rotation ? 180 : -180), b.skewX = b.skewY =
            0) : (b.skewX = g / c.DEG_TO_RAD, b.skewY = d / c.DEG_TO_RAD);
        return b
    };
    ...
    a.initialize = function (b) {
        ...
        if (null != b) {
            ...
            if (null != b.frames)if (b.frames instanceof Array) {
                ...
                a = b.frames;
                g = 0;
                for (d = a.length; g < d; g++)e = a[g], this._frames.push({image: this._images[e[4] ? e[4] : 0], rect: new createjs.Rectangle(e[0], e[1], e[2], e[3]), regX: e[5] || 0, regY: e[6] || 0})
            ...
            if (null != (d = b.animations)) {
                ...
                for (var h in d) {
                    b = {name: h};
                    e = d[h];
                    if ("number" == typeof e)a = b.frames = [e]; else if (e instanceof Array)if (1 == e.length)b.frames = [e[0]]; else {
                        b.frequency = e[3];
                        b.next = e[2];
                        a = b.frames = [];
    ...
    a._calculateFrames = function () {
        if (!(this._frames || 0 == this._frameWidth)) {
            ...
            for (var b = 0, g = this._frameWidth, d = this._frameHeight, a = 0, c = this._images; a < c.length; a++) {
                for (var e = c[a], h = (e.width + 1) / g | 0, m = (e.height + 1) / d | 0, m = 0 < this._numFrames ? Math.min(this._numFrames - b, h * m) : h * m, k = 0; k < m; k++)this._frames.push({image: e, rect: new createjs.Rectangle(k % h * g, (k / h | 0) * d, g, d), regX: this._regX, regY: this._regY});
                b += m
            }
            this._numFrames = b
        }
...
(function () {
    ...
    a.BASE_64 = {A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9,
    ...
    b.drawRoundRectComplex = function (b, d, a, f, e, h, m, k) {
        ...
        k > p && (k = p);
        this._dirty = this._active = !0;
        var p = this._ctx.arcTo, q = this._ctx.lineTo;
    ...
    b.drawEllipse = function (b, d, a, f) {
        this._dirty = this._active = !0;
        var e = 0.5522848 * (a / 2), h = 0.5522848 * (f / 2), m = b + a, k = d + f;
        a = b + a / 2;
        f = d + f / 2;
    ...
    b.decodePath = function (b) {
        for (var d = [this.moveTo, this.lineTo, this.quadraticCurveTo, this.bezierCurveTo,
            this.closePath], c = [2, 2, 4, 6, 0], f = 0, e = b.length, h = [], m = 0, k = 0, p = a.BASE_64; f < e;) {
            var s = b.charAt(f), r = p[s], t = r >> 3, v = d[t];
            ...
            r = (r >> 2 & 1) + 2;
            for (t = 0; t < s; t++) {
                var q = p[b.charAt(f)], u = q >> 5 ? -1 : 1, q = (q & 31) << 6 | p[b.charAt(f + 1)];
    ...
    b._updateInstructions = function () {
        ...
        this._strokeInstructions && (this._strokeStyleInstructions && this._instructions.push.apply(this._instructions, this._strokeStyleInstructions), this._instructions.push.apply(this._instructions, this._strokeInstructions), this._ignoreScaleStroke ? this._instructions.push(new c(this._ctx.save, [], !1), new c(this._ctx.setTransform,
            [1, 0, 0, 1, 0, 0], !1), a.strokeCmd, new c(this._ctx.restore, [], !1)) : this._instructions.push(a.strokeCmd))
    };
    b._newPath = function () {
        this._dirty && this._updateInstructions();
...
(function () {
    ...
    a.updateCache = function (b) {
        var a = this.cacheCanvas, d = this._cacheScale, j = this._cacheOffsetX * d, f = this._cacheOffsetY * d;
        if (!a)throw"cache() must be called before updateCache()";
        var e = a.getContext("2d");
        e.save();
        b ||
        e.clearRect(0, 0, a.width + 1, a.height + 1);
    ...
    a._tick = function (b) {
        ...
        a && a.tick && this.dispatchEvent({type: "tick", params: b})
    };
...
(function () {
    ...
    a.swapChildrenAt = function (b, a) {
        var d = this.children, c = d[b], f = d[a];
        c && f && (d[b] = f, d[a] = c)
    };
    ...
    a.getObjectsUnderPoint = function (b, a) {
        var d = [], c = this.localToGlobal(b, a);
    ...
    a._getObjectsUnderPoint = function (b, a, d, j) {
        var f = createjs.DisplayObject._hitTestContext, e = this._matrix, h = this._hasMouseHandler(j);
        if (!this.hitArea && (this.cacheCanvas && h) && (this.getConcatenatedMatrix(e), f.setTransform(e.a, e.b, e.c, e.d, e.tx - b, e.ty - a), f.globalAlpha = e.alpha, this.draw(f), this._testHit(f)))return f.setTransform(1,
            0, 0, 1, 0, 0), f.clearRect(0, 0, 2, 2), this;
        for (var m = this.children.length - 1; 0 <= m; m--) {
            var k = this.children[m], p = k.hitArea;
            if (k.visible && !(!p && !k.isVisible() || j && !k.mouseEnabled)) {
                ...
                } else if (!j || h || s)if (k.getConcatenatedMatrix(e), p && (e.appendTransform(p.x, p.y, p.scaleX, p.scaleY, p.rotation, p.skewX, p.skewY, p.regX, p.regY), e.alpha = p.alpha), f.globalAlpha =
                    e.alpha, f.setTransform(e.a, e.b, e.c, e.d, e.tx - b, e.ty - a), (p || k).draw(f), this._testHit(f)) {
                    f.setTransform(1, 0, 0, 1, 0, 0);
                    f.clearRect(0, 0, 2, 2);
                    if (h)return this;
                    if (d)d.push(k); else return k
                }
            }
        }
        return null
...
(function () {
    ...
    a.toDataURL = function (b, a) {
        a || (a = "image/png");
        var d = this.canvas.getContext("2d"), c = this.canvas.width, f = this.canvas.height, e;
        if (b) {
    ...
    a.enableMouseOver = function (b) {
        ...
        if (null == b)b = 20; else if (0 >= b)return;
        var a = this;
    ...
    a.enableDOMEvents = function (b) {
        ...
        if (!b && d) {
            ...
            d.mouseup = {t: b, f: function (b) {
                c._handleMouseUp(b)
            }};
            d.mousemove = {t: b, f: function (b) {
                c._handleMouseMove(b)
            }};
            d.dblclick = {t: b, f: function (b) {
                c._handleDoubleClick(b)
            }};
            d.mousedown = {t: this.canvas, f: function (b) {
    ...
    a._getPointerData = function (b) {
        ...
        if (!a && (a = this._pointerData[b] = {x: 0, y: 0}, null == this._primaryPointerID || -1 == this._primaryPointerID))this._primaryPointerID =
            b;
        return a
    };
    ...
    a._handlePointerMove = function (b, a, d, c) {
        if (this.canvas) {
            var f = this._getPointerData(b), e = f.inBounds;
    ...
    a._updatePointerPosition = function (b, a, d) {
        ...
        a -= c.left;
        d -= c.top;
        var f = this.canvas.width, e = this.canvas.height;
        a /= (c.right - c.left) / f;
        d /= (c.bottom - c.top) / e;
        c = this._getPointerData(b);
        (c.inBounds = 0 <= a && 0 <= d && a <= f - 1 && d <= e - 1) ? (c.x = a, c.y = d) : this.mouseMoveOutside &&
            (c.x = 0 > a ? 0 : a > f - 1 ? f - 1 : a, c.y = 0 > d ? 0 : d > e - 1 ? e - 1 : d);
        c.rawX = a;
        c.rawY = d;
    ...
    a._getElementRect = function (b) {
        ...
        try {
            ...
            a = {top: b.offsetTop, left: b.offsetLeft, width: b.offsetWidth, height: b.offsetHeight}
        }
        var c = (window.pageXOffset || document.scrollLeft || 0) - (document.clientLeft || document.body.clientLeft || 0), f = (window.pageYOffset || document.scrollTop || 0) - (document.clientTop || document.body.clientTop ||
            0), e = window.getComputedStyle ? getComputedStyle(b) : b.currentStyle;
        b = parseInt(e.paddingLeft) + parseInt(e.borderLeftWidth);
        var h = parseInt(e.paddingTop) + parseInt(e.borderTopWidth), m = parseInt(e.paddingRight) + parseInt(e.borderRightWidth), e = parseInt(e.paddingBottom) + parseInt(e.borderBottomWidth);
        return{left: a.left + c + b, right: a.right + c - m, top: a.top + f + h, bottom: a.bottom + f - e}
    };
    a._handleMouseUp = function (b) {
        this._handlePointerUp(-1, b, !1)
    };
    a._handlePointerUp = function (b, a, d) {
        var c = this._getPointerData(b), f;
        if (this.onMouseMove ||
            this.hasEventListener("stagemouseup"))f = new createjs.MouseEvent("stagemouseup", c.x, c.y, this, a, b, b == this._primaryPointerID, c.rawX, c.rawY), this.onMouseUp && this.onMouseUp(f), this.dispatchEvent(f);
        var e = c.event;
        ...
        if ((e = c.target) && (e.onClick || e.hasEventListener("click")) && this._getObjectsUnderPoint(c.x,
            c.y, null, !0, this._mouseOverIntervalID ? 3 : 1) == e)f = new createjs.MouseEvent("click", c.x, c.y, e, a, b, b == this._primaryPointerID, c.rawX, c.rawY), e.onClick && e.onClick(f), e.dispatchEvent(f);
    ...
    a._handlePointerDown = function (b, a, d, c) {
        ...
        if (this.onMouseDown || this.hasEventListener("stagemousedown"))d =
            new createjs.MouseEvent("stagemousedown", f.x, f.y, this, a, b, b == this._primaryPointerID, f.rawX, f.rawY), this.onMouseDown && this.onMouseDown(d), this.dispatchEvent(d);
    ...
    a._handleDoubleClick = function (b) {
        var a = this._getPointerData(-1), d = this._getObjectsUnderPoint(a.x, a.y, null, this._mouseOverIntervalID ? 3 : 1);
...
(function () {
    ...
    a._normalizeFrame = function () {
        var b = this._animation, a = this.currentFrame, d = this.paused, c;
        if (b)if (c = b.frames.length, this.currentAnimationFrame >= c) {
            var f = b.next;
            this._dispatchAnimationEnd(b, a, d, f, c - 1) || (f ? this._goto(f) : (this.paused = !0, this.currentAnimationFrame = b.frames.length - 1, this.currentFrame =
                b.frames[this.currentAnimationFrame]))
        } else this.currentFrame = b.frames[this.currentAnimationFrame]; else c = this.spriteSheet.getNumFrames(), a >= c && !this._dispatchAnimationEnd(b, a, d, c - 1) && (this.currentFrame = 0)
    };
    a._dispatchAnimationEnd = function (b, a, d, c, f) {
        var e = b ? b.name : null;
        this.onAnimationEnd && this.onAnimationEnd(this, e, c);
        this.dispatchEvent({type: "animationend", name: e, next: c});
...
(function () {
    ...
    a._drawText = function (b) {
        ...
        for (var d = String(this.text).split(/(?:\r\n|\r|\n)/), c = this.lineHeight || this.getMeasuredLineHeight(), f = 0, e = 0, h = d.length; e <
            ...
            if (null == this.lineWidth || m < this.lineWidth)a && this._drawTextLine(b, d[e], f * c); else {
...
(function () {
    ...
    c.extractFrame = function (a, b) {
        ...
        var g = a.getFrame(b);
        if (!g)return null;
        var d = g.rect, j = c._workingCanvas;
        j.width =
            d.width;
        j.height = d.height;
    ...
    c._flip = function (a, b, g, d) {
        ...
        f = e.length / b;
        for (m = 0; m < f; m++) {
            var k = e[m], s = k.rect.clone(), p = j[k.image.__tmp + h * b], r = {image: p, rect: s, regX: k.regX,
                regY: k.regY};
        ...
        for (m = 0; m < j; m++) {
            e = d[m];
            k = a[e];
            h = {name: e + g, frequency: k.frequency, next: k.next, frames: []};
            k.next && (h.next += g);
            e = k.frames;
            k = 0;
...
(function () {
    ...
    a.addFrame = function (b, a, d, j, f, e) {
        ...
        if (!a)return null;
        d = d || 1;
        return this._frames.push({source: b, sourceRect: a, scale: d, funct: j, params: f, scope: e, index: this._frames.length, height: a.height * d}) - 1
    };
    a.addAnimation = function (b, a, d, j) {
        if (this._data)throw c.ERR_RUNNING;
        this._animations[b] = {frames: a, next: d, frequency: j}
    };
    a.addMovieClip = function (b, a, d) {
        if (this._data)throw c.ERR_RUNNING;
        var j = b.frameBounds, f = a || b.bounds || b.nominalBounds;
        ...
        b = [];
        for (var m in h)b.push({index: h[m], label: m});
        if (b.length) {
            b.sort(function (b, a) {
    ...
    a._startBuild = function () {
        ...
        var a = [];
        this._data = {images: [], frames: a, animations: this._animations};
    ...
    a._fillRow = function (b, a, d, j, f) {
        ...
        for (var h = h - a, m = f, k = 0, p = b.length - 1; 0 <= p; p--) {
            var s = b[p], r = this._scale * s.scale, t = s.sourceRect, v = s.source, q = Math.floor(r * t.x - f), u = Math.floor(r * t.y - f), w = Math.ceil(r * t.height + 2 * f), t = Math.ceil(r * t.width + 2 * f);
    ...
    a._run = function () {
        ...
        this.dispatchEvent({type: "progress", progress: b})
    };
    a._drawNext =
        function () {
            var b = this._frames[this._index], a = b.scale * this._scale, d = b.rect, c = b.sourceRect, f = this._data.images[b.img].getContext("2d");
...
(function () {
    ...
    a.draw = function () {
        if (null != this.htmlElement) {
            var b = this.getConcatenatedMatrix(this._matrix), a = this.htmlElement.style;
            if (this.visible)a.visibility = "visible"; else return!0;
            var d = this._oldMtx || {};
...
(function () {
    ...
    c.enable = function (a, b, g) {
        ...
        a.__touch = {pointers: {}, multitouch: !b, preventDefault: !g, count: 0};
    ...
    c._IOS_enable = function (a) {
        var b = a.canvas, g = a.__touch.f = function (b) {
    ...
    c._IE_handleEvent = function (a, b) {
        if (a) {
            ...
            var c = b.type,
                d = b.pointerId, j = a.__touch.activeIDs;
            if ("MSPointerDown" == c)b.srcElement == a.canvas && (j[d] = !0, this._handleStart(a, d, b, b.pageX, b.pageY)); else if (j[d])if ("MSPointerMove" == c)this._handleMove(a, d, b, b.pageX, b.pageY); else if ("MSPointerUp" == c || "MSPointerCancel" == c)delete j[d], this._handleEnd(a, d, b)
        }
    };
...
(function () {
    ...
    a.initialize = function (b, a, d) {
        ...
        this._steps = [];
        this._actions = [];
        a && a.paused ? this._paused = !0 : c._register(this,
            !0);
    ...
    a.wait = function (b) {
        ...
        return this._addStep({d: b, p0: a, e: this._linearEase, p1: a})
    };
    a.to = function (b, a, d) {
        if (isNaN(a) || 0 > a)a = 0;
        return this._addStep({d: a || 0, p0: this._cloneProps(this._curQueueProps), e: d, p1: this._cloneProps(this._appendQueueProps(b))})
    };
    a.call = function (b, a, d) {
        return this._addAction({f: b, p: a ? a : [this], o: d ? d : this._target})
    };
    a.set = function (b, a) {
        return this._addAction({f: this._set,
            o: this, p: [b, a ? a : this._target]})
    };
    a.play = function (b) {
    ...
    a.setPosition = function (b, a) {
        ...
        if (this._target)if (c)this._updateTargetProps(null, 1); else if (0 < this._steps.length) {
            for (var e = 0, h = this._steps.length; e <
                h && !(this._steps[e].t > d); e++);
            e = this._steps[e - 1];
    ...
    a._runActions = function (b, a, d) {
        var c = b, f = a, e = -1, h = this._actions.length, m = 1;
...
(function () {
    ...
    a.initialize = function (a, c, d) {
        ...
        this.setLabels(c);
        d && d.paused ? this._paused = !0 : createjs.Tween._register(this,
            !0);
    ...
    a.removeTween = function (a) {
        ...
        if (1 < c) {
            for (var d =
                !0, j = 0; j < c; j++)d = d && this.removeTween(arguments[j]);
            return d
        }
        if (0 == c)return!1;
    ...
    a.setPosition = function (a, c) {
        0 > a && (a = 0);
        var d = this.loop ? a % this.duration : a, j = !this.loop && a >= this.duration;
...
(function () {
    ...
    c.calc = function (a, b, g) {
        ...
        void 0 == g && (g = {x: 0, y: 0, rotation: 0});
        var d = a._segments, j = a.path, f = a._length * b, e = d.length - 2;
        for (b = 0; f > d[b] && b < e;)f -= d[b], b += 2;
        for (var d =
            d[b + 1], h = 0, e = d.length - 1; f > d[h] && h < e;)f -= d[h], h++;
        f = h / ++e + f / (e * d[h]);
        b = 2 * b + 2;
        e = 1 - f;
...
(function () {
    ...
    c.sendFileLoadEvent = function (a) {
        if (c.preloadHash[a])for (var b = 0, g = c.preloadHash[a].length; b < g; b++) {
            var e = c.preloadHash[a][b], h = {target: this, type: "fileload", src: e.src, id: e.id, data: e.data};
            c.preloadHash[a][b] = !0;
            c.dispatchEvent(h);
            c.onLoadComplete && c.onLoadComplete(h);
            h = {target: this, type: "loadComplete", src: e.src, id: e.id, data: e.data};
            c.dispatchEvent(h)
        }
    };
    ...
    c.getCapability = function (a) {
        return null ==
            c.activePlugin ? null : c.activePlugin.capabilities[a]
    };
    ...
    c.registerSound = function (b, g, f, e) {
        ...
        null != k && (null != k.numChannels && (m = k.numChannels),
            a.create(h.src, m), null == f || !isNaN(f) ? f = h.data = m || a.maxPerChannel() : f.channels = h.data.channels = m || a.maxPerChannel(), null != k.tag ? h.tag = k.tag : k.src && (h.src = k.src), null != k.completeHandler && (h.completeHandler = k.completeHandler), k.type && (h.type = k.type));
        !1 != e && (c.preloadHash[h.src] || (c.preloadHash[h.src] = []), c.preloadHash[h.src].push({src: b, id: g, data: f}), 1 == c.preloadHash[h.src].length && c.activePlugin.preload(h.src, k));
        return h
    };
    c.registerManifest = function (a) {
        for (var b = [], c = 0, g = a.length; c < g; c++)b[c] = createjs.Sound.registerSound(a[c].src,
            a[c].id, a[c].data, a[c].preload);
        return b
    };
    ...
    c.parsePath = function (a, b, g, e) {
        ...
        b = {type: b || "sound", id: g, data: e};
        g = c.getCapabilities();
        e = 0;
        for (var h = a.length; e < h; e++) {
            var m = a[e], k = m.match(c.FILE_PATTERN);
            if (null == k)return!1;
            var p = k[4], k = k[5];
            if (g[k] && -1 < c.SUPPORTED_EXTENSIONS.indexOf(k))return b.name = p, b.src = m, b.extension =
                k, b
        }
        return null
    };
    ...
    var g = a.prototype = {src: null, max: null, maxDefault: 100, length: 0, init: function (a, b) {
        this.src = a;
        ...
        for (var b, g, e = 0, h = this.max; e < h; e++) {
            b = this.get(e);
            if (null == b)return!0;
            if (!(a == c.INTERRUPT_NONE && b.playState != c.PLAY_FINISHED))if (0 == e)g = b; else if (b.playState == c.PLAY_FINISHED || b.playState == c.PLAY_INTERRUPTED || b.playState == c.PLAY_FAILED)g = b; else if (a == c.INTERRUPT_EARLY && b.getPosition() < g.getPosition() || a == c.INTERRUPT_LATE && b.getPosition() > g.getPosition())g = b
        }
        return null != g ? (g.interrupt(),
            this.remove(g), !0) : !1
    }, toString: function () {
...
(function () {
    ...
    c.generateCapabilities = function () {
        if (null == c.capabilities) {
            ...
            if (window.webkitAudioContext)c.context =
                new webkitAudioContext; else if (window.AudioContext)c.context = new AudioContext; else return null;
            c.playEmptySound();
            c.capabilities = {panning: !0, volume: !0, tracks: -1};
    ...
    c.prototype = {capabilities: null, volume: 1, context: null, dynamicsCompressorNode: null, gainNode: null, arrayBuffers: null, init: function () {
    ...
    a.prototype = {src: null, uniqueId: -1, playState: null, owner: null, offset: 0, delay: 0, volume: 1, pan: 0, duration: 0, remainingLoops: 0, delayTimeoutId: null, soundCompleteTimeout: null, panNode: null, gainNode: null, sourceNode: null, sourceNodeNext: null, muted: !1, paused: !1, startTime: 0, addEventListener: null, removeEventListener: null, removeAllEventListeners: null,
        dispatchEvent: null, hasEventListener: null, _listeners: null, endedHandler: null, readyHandler: null, stalledHandler: null, onReady: null, onPlaySucceeded: null, onPlayInterrupted: null, onPlayFailed: null, onComplete: null, onLoop: null, sendEvent: function (a) {
            this.dispatchEvent({target: this, type: a})
        }, init: function (a, b) {
            this.owner = b;
            this.src = a;
            ...
            this.owner.isPreloadComplete(this.src) &&
            (this.duration = 1E3 * this.owner.arrayBuffers[this.src].duration);
        ...
        handleSoundReady: function () {
            if (null != window.createjs)if (1E3 * this.offset > this.getDuration())this.playFailed(); else {
            ...
            return!this.paused && this.playState == createjs.Sound.PLAY_SUCCEEDED ? (this.paused = !0, this.offset = this.owner.context.currentTime - this.startTime, this.cleanUpAudioNode(this.sourceNode), this.cleanUpAudioNode(this.sourceNodeNext), 0 !=
                this.panNode.numberOfOutputs && this.panNode.disconnect(), clearTimeout(this.delayTimeoutId), clearTimeout(this.soundCompleteTimeout), !0) : !1
        }, resume: function () {
            ...
            return a !=
                this.gainNode.gain.value ? (this.gainNode.gain.value = a, !0) : !1
        }, getVolume: function () {
            return this.volume
        }, mute: function (a) {
            this.muted = a;
            ...
            if (this.owner.capabilities.panning)this.panNode.setPosition(a, 0, -0.5), this.pan = a; else return!1
        }, getPan: function () {
            return this.pan
    ...
    b.prototype = {request: null, owner: null, progress: -1, src: null, result: null, onload: null, onprogress: null, onError: null, init: function (a, b) {
        this.src = a;
        this.owner = b
    }, load: function (a) {
        null != a && (this.src = a);
        ...
        this.progress = a / b;
        if (null != this.onprogress)this.onprogress({loaded: a, total: b, progress: this.progress})
    }, handleLoad: function () {
...
(function () {
    ...
    c.prototype = {capabilities: null, audioSources: null, defaultNumChannels: 2, init: function () {
        ...
        if (!this.isPreloadStarted(b)) {
            var c = g.get(b), f = this.createTag(b);
            c.add(f);
    ...
    a.prototype = {src: null, uniqueId: -1, playState: null, owner: null, loaded: !1, offset: 0, delay: 0, volume: 1, pan: 0, duration: 0, remainingLoops: 0, delayTimeoutId: null, tag: null, muted: !1, paused: !1, addEventListener: null, removeEventListener: null, removeAllEventListeners: null,
        dispatchEvent: null, hasEventListener: null, _listeners: null, onComplete: null, onLoop: null, onReady: null, onPlayFailed: null, onPlayInterrupted: null, onPlaySucceeded: null, endedHandler: null, readyHandler: null, stalledHandler: null, loopHandler: null, init: function (a, b) {
            this.src = a;
            this.owner = b;
            this.endedHandler = createjs.proxy(this.handleSoundComplete, this);
            this.readyHandler = createjs.proxy(this.handleSoundReady, this);
        ...
        interrupt: function () {
            ...
            e.addEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED, this.endedHandler,
                !1);
            this.offset = a;
            this.volume = c;
            this.updateVolume();
    ...
    createjs.EventDispatcher.initialize(a.prototype);
    b.prototype = {src: null, tag: null, preloadTimer: null, loadedHandler: null, init: function (a, b) {
        this.src = a;
        this.tag = b;
    ...
    g.prototype = {src: null, length: 0, available: 0, tags: null, init: function (a) {
        this.src = a;
        this.tags = []
    }, add: function (a) {
        this.tags.push(a);
...
(function () {
    ...
    a._sendProgress = function (a) {
        if (!this._isCanceled()) {
            var c = null;
            if ("number" == typeof a)this.progress = a, c = {loaded: this.progress, total: 1}; else if (c = a, this.progress = a.loaded / a.total, isNaN(this.progress) || Infinity == this.progress)this.progress = 0;
            c.target =
                this;
            c.type = "progress";
...
(function () {
    ...
    a.remove = function (a) {
        ...
        if (b) {
            for (; b.length;) {
                ...
                for (e =
                         this._loadQueueBackup.length - 1; 0 <= e; e--)if (h = this._loadQueueBackup[e].getItem(), h.id == c || h.src == c) {
                    this._loadQueueBackup.splice(e, 1)[0].cancel();
                    break
                }
                if (f)delete this._loadItemsById[f.id], delete this._loadItemsBySrc[f.src], this._disposeItem(f); else for (var e = this._currentLoads.length - 1; 0 <= e; e--) {
    ...
    a.installPlugin = function (a) {
        if (!(null == a || null == a.getPreloadHandlers)) {
            ...
            if (null != a.types)for (var b = 0, c =
                a.types.length; b < c; b++)this._typeCallbacks[a.types[b]] = a.callback;
    ...
    a.getResult = function (a, b) {
        ...
        c = c.id;
        return b && this._loadedRawResults[c] ?
            this._loadedRawResults[c] : this._loadedResults[c]
    };
    a.setPaused = function (a) {
    ...
    a._addItem = function (a, b) {
        ...
        if (null != c) {
            ...
            null != f && (this._loadQueue.push(f), this._loadQueueBackup.push(f), this._numItems++, this._updateProgress(), this.maintainScriptOrder &&
                (c.type == createjs.LoadQueue.JAVASCRIPT && f instanceof createjs.XHRLoader) && (this._scriptOrder.push(c), this._loadedScripts.push(null)))
        }
    };
    a._createLoadItem = function (a) {
        ...
        b.type == createjs.LoadQueue.JSON && null != b.callback &&
        ...
        if (a = this._typeCallbacks[b.type] || this._extensionCallbacks[b.ext]) {
            ...
            if (!1 === a)return null;
            !0 !== a && (null != a.src && (b.src = a.src), null != a.id && (b.id = a.id), null != a.tag && a.tag.load instanceof Function && (b.tag = a.tag), null != a.completeHandler && (b.completeHandler =
                a.completeHandler));
    ...
    a._handleFileComplete = function (a) {
        ...
        if (this.maintainScriptOrder && b.type == createjs.LoadQueue.JAVASCRIPT)if (a instanceof createjs.TagLoader)this._currentlyLoadingScript = !1; else {
    ...
    a._createTag = function (a) {
        ...
        switch (a) {
            ...
            case createjs.LoadQueue.CSS:
                return b = this.useXHR ? document.createElement("style") : document.createElement("link"), b.rel = "stylesheet",
                    b.type = "text/css", b;
    ...
    a._sendFileProgress = function (a, b) {
        if (this._isCanceled())this._cleanUp(); else {
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function (a) {
        ...
        if (0 === c)return-1;
        var f = 0;
        1 < arguments.length && (f = Number(arguments[1]), f != f ? f = 0 : 0 != f && (Infinity !=
            f && -Infinity != f) && (f = (0 < f || -1) * Math.floor(Math.abs(f))));
        if (f >= c)return-1;
...
(function () {
    ...
    a.load = function () {
        if (null == this._request)this._handleError(); else {
            ...
            this._request.onreadystatechange = createjs.proxy(this._handleReadyStateChange,
                this);
            try {
    ...
    a._handleLoad = function () {
        this.loaded || (this.loaded = !0, this._checkError() ? (this._response = this._getResponse(),
            this._clean(), this._generateTag() && this._sendComplete()) : this._handleError())
    };
    a._handleTimeout = function () {
        this._clean();
        this._sendError({reason: "PRELOAD_TIMEOUT"})
    ...
    a._createXHR = function (a) {
        ...
        d = null;
        if (c && window.XDomainRequest)d = new XDomainRequest; else if (window.XMLHttpRequest)d = new XMLHttpRequest; else try {
        ...
        a.type ==
            createjs.LoadQueue.TEXT && d.overrideMimeType && d.overrideMimeType("text/plain; charset=x-user-defined");
        this._xhrLevel = "string" === typeof d.responseType ? 2 : 1;
        var h = null, h = a.method == createjs.LoadQueue.GET ? this.buildPath(a.src, this._basePath, a.values) : this.buildPath(a.src, this._basePath);
        ...
        a.values && a.method == createjs.LoadQueue.POST && d.setRequestHeader("Content-Type",
        ...
        switch (this._item.type) {
            case createjs.LoadQueue.IMAGE:
                return a.onload = createjs.proxy(this._handleTagReady, this),
                    a.src = this.buildPath(this._item.src, this._basePath, this._item.values), this._rawResponse = this._response, this._response = a, !1;
            case createjs.LoadQueue.JAVASCRIPT:
            ...
            case createjs.LoadQueue.CSS:
                ...
                if (a.styleSheet)a.styleSheet.cssText = this._response; else {
    ...
    a._parseXML = function (a, c) {
        var d = null;
        window.DOMParser ?
            d = (new DOMParser).parseFromString(a, c) : (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = !1, d.loadXML(a));
        return d
    };
...
(function () {
    ...
    "function" !== typeof JSON.stringify && (JSON.stringify = function (a, c, d) {
        var e;
        f = j = "";
        if ("number" === typeof d)for (e = 0; e < d; e += 1)f += " "; else"string" === typeof d && (f = d);
    ...
    "function" !== typeof JSON.parse && (JSON.parse = function (a, b) {
        ...
        if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
            "]").replace(/(?:^|:|,)(?:\s*\[)+/g, "")))return d = eval("(" + a + ")"), "function" === typeof b ? c({"": d}, "") : d;
...
(function () {
    ...
    a.initialize = function (b, a, c, f) {
        ...
        this.loop = c;
        props = {paused: !0, position: a, useTicks: !0};
        this.Container_initialize();
    ...
    a._updateTimeline = function () {
        var b = this.timeline, a = b._tweens, c = this.children,
            f = this.mode != d.INDEPENDENT;
        ...
        if (this._prevPos != b._prevPos) {
            ...
            for (b = a.length - 1; 0 <= b; b--)e = a[b], f = e._target, f != this && (e = e._stepPosition, f instanceof
                createjs.DisplayObject ? this._addManagedChild(f, e) : this._setState(f.state, e));
            for (b = c.length - 1; 0 <= b; b--)a = c[b].id, 1 == this._managed[a] && (this.removeChildAt(b), delete this._managed[a])
        }
    };
    ...
    a._addManagedChild = function (b, a) {
        b._off || (this.addChild(b), b instanceof d && (b._synchOffset = a, b.mode == d.INDEPENDENT && (b.autoReset && !this._managed[b.id]) && b._reset()), this._managed[b.id] =
            2)
    };
